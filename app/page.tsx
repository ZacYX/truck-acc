...
export default function Home() {
  ...
  return (
    <div>
      <div className="relative-box h-screen bg-[url('/images/tent-sky.jpg')] bg-cover bg-center ">
      ...
      <div className="relative-box min-h-[50vh] bg-[url('/images/tent-night.jpg')] bg-cover bg-center ">
      ...
      <div className="relative-box bg-[url('/images/tents.jpg')] bg-cover bg-center">
        <div className="content-box flex-col">
